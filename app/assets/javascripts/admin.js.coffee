      ...
      if (confirm)
        ...
        $.post("/admin/payments/" + paymentId + "/refund")
          ...
          .fail(() ->
            ...
            setTimeout(() ->
              alert('Sorry, this payment could not be refunded. These funds may have already been released to you. If you have any questions, please contact support@altheahealth.com with the payment ID.')
            , 300)
          )
          .always(() ->
            loader.hide()
