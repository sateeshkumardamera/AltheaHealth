  ...
  def create_admin_bank_account
    if params[:ct_bank_id].blank?
      ...
      begin
        ...
        flash = { :error => "An error occurred, please contact support@altheahealth.com: #{exception.message}" }
      else
  ...
  def admin_bank_account
    ...
    begin
      ...
      if response['bank'] # default bank is already set up
        ...
        flash.now[:error] = "An error occurred, please contact support@altheahealth.com" # this should never happen
      end
    end
