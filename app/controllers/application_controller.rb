    ...
    if !@settings.initialized_flag
      if current_user
        ...
        begin
          ...
          redirect_to new_user_registration_url, :flash => { :error => "An error occurred, please contact support@altheahealth.com: #{exception.message}" }
          return
        else
